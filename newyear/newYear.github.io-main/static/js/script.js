...
const helpContent = {
  shellType: {
    ...
    body: "Loại pháo hoa bạn muốn bật, chọn “Ngẫu nhiên (Random)” để có trải nghiệm tuyệt vời!",
  },
  shellSize: {
    header: "Kích thước pháo hoa",
    body: "Pháo hoa càng lớn thì phạm vi nở càng rộng, nhưng pháo hoa lớn sẽ cần hiệu suất thiết bị cao hơn, và có thể gây giật lag trên thiết bị của bạn.",
  },
  quality: {
    header: "Chất lượng đồ họa",
    body: "Nếu hoạt ảnh không mượt mà, bạn có thể thử giảm chất lượng đồ họa. Chất lượng đồ họa càng cao, số lượng tia lửa sau khi pháo hoa nở càng nhiều, nhưng chất lượng cao có thể làm thiết bị của bạn giật lag.",
  },
  skyLighting: {
    header: "Chiếu sáng bầu trời",
    body: "Khi pháo hoa phát nổ, nền sẽ được chiếu sáng. Nếu màn hình của bạn quá sáng, bạn có thể thay đổi thành “Tối” hoặc “Không”.",
  },
  scaleFactor: {
    header: "Phóng to thu nhỏ",
    body: "Giúp bạn gần hơn hoặc xa hơn với pháo hoa. Đối với pháo hoa lớn, bạn có thể chọn giá trị thu nhỏ nhỏ hơn, đặc biệt là trên điện thoại hoặc máy tính bảng.",
  },
  autoLaunch: {
    header: "Tự động bật pháo hoa",
    body: "Khi bật, bạn có thể ngồi trước màn hình thiết bị và thưởng thức pháo hoa, bạn cũng có thể tắt nó, nhưng khi tắt, bạn sẽ phải nhấn vào màn hình để bật pháo hoa.",
  },
  finaleMode: {
    header: "Bật nhiều pháo hoa cùng lúc",
    body: "Có thể tự động bật nhiều pháo hoa cùng lúc (nhưng cần bật trước “Tự động bật pháo hoa”).",
  },
  hideControls: {
    header: "Ẩn nút điều khiển",
    body: "Ẩn các nút trên màn hình. Nếu bạn muốn chụp ảnh màn hình hoặc cần một trải nghiệm liền mạch, bạn có thể ẩn nút, sau khi ẩn nút, bạn vẫn có thể mở cài đặt ở góc trên bên phải.",
  },
  fullscreen: {
    header: "Chế độ toàn màn hình",
    body: "Chuyển sang chế độ toàn màn hình",
  },
  longExposure: {
    header: "Giữ lại tia lửa pháo hoa",
    body: "Có thể giữ lại tia lửa pháo hoa còn lại",
  },
};
